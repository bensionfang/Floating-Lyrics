...
// --- 歌名本身帶版本尾綴,而兩邊用不同寫法 (播放器給破折號、QQ 標頭給括號) ---
nameCase('標頭 / 歌名的版本尾綴兩邊形狀不同',
  '[00:00.00]クズリ念 (Live in Studio_温蔵庫) - ずっと真夜中でいいのに。 (永遠是深夜有多好｡)\n[00:24.50]詞：ACAね\n[00:42.31]歌詞',
  'クズリ念 - Live in Studio_温蔵庫', { idx: 0, want: true });
nameCase('標頭 / 歌名帶破折號尾綴,標頭只寫原曲名',
  '[00:00.00]怪獣の花唄 - Vaundy\n[00:03.89]歌詞',
  '怪獣の花唄 - replica -', { idx: 0, want: true });
// 不該標:無空白連字號是名字本身,不可以當成版本尾綴剝掉
nameCase('標頭 / 歌名的無空白連字號不剝',
  '[00:00.00]go!go! - vanillas\n[00:03.89]歌詞',
  'go!go!vanillas', { idx: 0, want: false });

// --- 引號包起來的歌名標頭 (網易/QQ 的 `「歌名」`,全庫漏標 2 首) ---
nameCase('歌名 / 「」包起來的標頭',
  '[00:00.00]作词 : 山口一郎\n[00:00.95]「夜の踊り子」\n[00:05.00]跳ねた跳ねた',
  '夜の踊り子', { idx: 1, want: true });
nameCase('歌名 / 《》包起來的標頭',
  '[00:00.00]作词 : 甲\n[00:00.95]《告白氣球》\n[00:05.00]歌詞',
  '告白氣球', { idx: 1, want: true });
// 但仍要壓著「前面每一行都是製作人員列」那道閘門:唱出來的引號句不能被吃掉
nameCase('歌名 / 真歌詞之後的「歌名」不算',
  '[00:00.00]歌詞一\n[00:03.89]「夜の踊り子」',
  '夜の踊り子', { idx: 1, want: false });

// --- 無冒號式只在標頭區塊內才算 (全庫誤殺 11 行正文,全是英文歌詞裡的 music/bass/lyric) ---
nameCase('無冒號 / 正文裡的 music 不算製作人員列',
  '[00:00.00]作词 : 甲\n[00:20.00]We live in this way\n[00:22.00]Greatest music saves the day',
  'Live in This Way', { idx: 2, want: false });
nameCase('無冒號 / 標頭區塊內照舊要標',
  '[00:00.00]作词 : 甲\n[00:01.00]Vocal 初音ミク\n[00:20.00]歌詞',
  '某某', { idx: 1, want: true });
